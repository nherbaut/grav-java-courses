...
On peut ainsi collecter les éléments d’un stream sous la forme d’une [List](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html), d’un
